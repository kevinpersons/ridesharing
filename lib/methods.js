Meteor.methods({
  ...
  insertRide: function(nowTime, destination, departureDateTime, numSeats,
    ...
    Rides.insert({
      ...
      timeDifference: departureDateTime - nowTime,
  ...
  insertAsk: function(destTextA, userA, durTextA, dolTextA, whenA) {
    Asks.insert({
